...
from tasks.views import TaskListView, TaskDetailView, CreateOrEditTaskView, DeleteTaskView, TaskCreateView, AddAnswerView, SubordinatesTasksView, AddCommentView
